...
@ConditionalOnBean({SpringDataMaterialRepository.class, SpringDataMaterialVersionRepository.class, SpringDataProcessingJobRepository.class})
public class MaterialUploadPersistenceConfiguration {
    ...
    MaterialUploadPersistence materialUploadPersistence(
        ...
        return new JpaMaterialUploadPersistence(materials, versions, jobs);
    }
}
